	...
	return (
		<div className="mt-6 flex items-center justify-between">
			...
			<div className="flex items-center gap-2">
				{hasPrevPage ? (
					<Link href={buildHref(Math.max(1, currentPage - 1))} className="px-3 py-1 border rounded-md hover:bg-accent">
						Previous
					</Link>
				) : (
				...
				{hasNextPage ? (
					<Link href={buildHref(Math.min(totalPages, currentPage + 1))} className="px-3 py-1 border rounded-md hover:bg-accent">
						Next
					</Link>
				) : (
