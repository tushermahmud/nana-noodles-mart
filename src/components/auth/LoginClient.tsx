        ...
        >
          <Card className="w-full max-w-md border-2 border-pink-100 bg-white/90 backdrop-blur-sm anime-border">
            <CardHeader className="text-center pb-8">
              ...
              <CardTitle className="text-3xl font-black text-gray-900 anime-title">Welcome Back!</CardTitle>
              <p className="text-gray-600 mt-2 pop-text">Sign in to your Nana's Noodle Mart account</p>
            </CardHeader>
            ...
            <CardContent>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.5 }} className="flex items-center justify-between">
                ...
                {/* Sign Up Link */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.9 }} className="text-center">
          ...
          <div className="relative">
            ...
            <div className="text-center lg:text-left">
              <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.4 }} className="text-5xl md:text-7xl font-black text-gray-900 mb-6 anime-title">
                Welcome to <span className="gradient-text anime-text-shadow">Nana's Kitchen</span>
              </motion.h1>
              <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="text-xl text-gray-600 mb-8 pop-text">
                Sign in to access your account and enjoy our delicious ramen collection. Track your orders, save your favorites, and get exclusive offers.
              </motion.p>
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.8 }} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center"><span className="text-2xl">🍜</span></div>
                  <div><h3 className="font-bold text-gray-900 anime-title">Track Orders</h3><p className="text-gray-600 text-sm pop-text">Monitor your ramen journey</p></div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center"><span className="text-2xl">❤️</span></div>
                  <div><h3 className="font-bold text-gray-900 anime-title">Save Favorites</h3><p className="text-gray-600 text-sm pop-text">Keep your favorite dishes</p></div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-yellow-100 rounded-full flex items-center justify-center"><span className="text-2xl">🎁</span></div>
                  <div><h3 className="font-bold text-gray-900 anime-title">Exclusive Offers</h3><p className="text-gray-600 text-sm pop-text">Get special discounts</p></div>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center"><span className="text-2xl">🚀</span></div>
                  <div><h3 className="font-bold text-gray-900 anime-title">Fast Checkout</h3><p className="text-gray-600 text-sm pop-text">Quick and secure payments</p></div>
                </div>
              </motion.div>
            </div>
