...
export const metadata: Metadata = {
  ...
  description: "Discover authentic ramen and Asian cuisine at Nana's Noodle Mart. Premium ingredients, traditional recipes, and unforgettable flavors since 1974.",
